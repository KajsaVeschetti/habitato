...
function FossilFuel () {
  ...
  return ( 
    <>
      ...
      <Card.Img className="px-lg-5 pb-5" variant="top" src={fossilFuel} alt="Factories, with smoke coming out of large chimneys"/>
      ...
      <Collapse in={openButton}> 
       <div id="fuel-collapse-text">
        ...
        <Card.Text className="text-left p-2">Vår förbrukning av fossila bränslen sker i snabbare takt än det återskapas. Det är en icke-förnybar energikälla som en dag kommer ta slut. Det är därför viktig att hitta hållbara alternativ. Världsnaturfonden menar att förnybar energi, såsom exempelvis solkraft, vattenkraft och vindkraft, är miljövänliga alternativ till fossila bränslen. Det beror på att med förnybar energi slipper vi föroreningar och farliga restprodukter, det är energikällor som aldrig tar slut och de påverkar inte naturen negativt.</Card.Text>
