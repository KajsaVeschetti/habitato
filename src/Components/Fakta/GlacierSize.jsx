...
function GlacierSize () {
  ...
  return ( 
    <>
      <Card.Img className="px-lg-5 pb-5" variant="top" src={glacierSize} fluid alt="Glaciers in water"/>
     ...
     <Collapse in={openButton}>
        <div className="Glacier-collapse-content">
         <Card.Title>Vilka konsekvenserna får smältande glaciärer?</Card.Title>
